...
Dependencies are imported lazily so importing ``agentguard.contrib`` costs
nothing. Install what you use:

    pip install "agentguard[pgvector]"   # PostgreSQL + pgvector retrieval
    pip install "agentguard[anthropic]"  # Claude via the official SDK
"""
